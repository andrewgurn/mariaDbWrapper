...
*****************************************************************/
	...
	//EXAMPLE FUNCTION- Add or Change to suit your needs
	
	function getNoParamsNeededDropdown($elementID, $orderBy = 1, $withBlank = true, $preSelected = '', $valueAndTextAreDifferent = true, $excludeDisabled = true)
	{
		return $this->buildDropdown($elementID, 'tableName', 'idColumn', 'descriptionColumn', $orderBy, $withBlank, $preSelected, $valueAndTextAreDifferent, $excludeDisabled);
	}
...
*****************************************************************/
	...
	function getParamedicsDropdown($elementID)
	{
		$sql ="
			select 
				p.id 
		...
		return $this->buildComplicatedDropdown($elementID, $sql, $paramsArray, true, '', true);	
	}
